sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ui/model/json/JSONModel", "sap/suite/ui/commons/util/DateUtils", "sap/m/MessageToast"],
	function (Controller, JSONModel, DateUtils, MessageToast) {
		...
		function getBasePath() {
			return sap.ui.require.toUrl("yui5demokhempat");
		}
		...
		var oPageController = Controller.extend("yui5demokhempat.controller.View1", {
			onInit: function () {
				var oModel = new JSONModel(sap.ui.require.toUrl("yui5demokhempat/data.json"));
                ...
                this.getView().setModel("custom",oModel);
			},
			...
			dataChanged: function (oEvent) {
				...
				var oModel = new JSONModel(sap.ui.require.toUrl("yui5demokhempat/" + sFileName));
				oModel.attachRequestCompleted(convertData);
				this.getView().setModel(oModel);
			},
