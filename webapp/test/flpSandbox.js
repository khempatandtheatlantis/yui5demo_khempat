		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Khempat Timeline Application",
									"targetURL": "#yui5demokhempat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yui5demokhempat-display": {
								"semanticObject": "yui5demokhempat",
								"action": "display",
								"description": "Khempat Timeline application.",
								"title": "Khempat Timeline Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yui5demokhempat",
									"url": sap.ui.require.toUrl("yui5demokhempat")
								}
							}
						}
					}
